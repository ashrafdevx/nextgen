const AboutUs = () => {
  return (
    <>
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center md:justify-between px-16 bg-white  md:px-16 py-10 md:py-16">
        {/* Left Section */}
        <div className="max-w-xl text-center md:text-left">
          <button className="border  transition duration-300 border-black hover:border-black px-8 py-2 rounded-full text-md mb-5 hover:bg-black hover:text-white ease-in-out transition delay-75">
            About Us
          </button>
          <div>
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center md:justify-between px-16 bg-white  md:px-16 py-10 md:py-8">
        {/* Right Section */}
        <div className="mt-8 md:mt-0 max-w-2xl">
          <img
        ...
        {/* Left Section */}
        <div className="max-w-xl text-center md:text-left">
          <button className="border  duration-300 border-black hover:border-black px-8 py-2 rounded-full text-md mb-5 hover:bg-black hover:text-white ease-in-out transition delay-75">
            Service
          </button>
          <div>
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center md:justify-between px-16 bg-white  md:px-16 py-10 md:py-16">
        ...
        <div className="mt-8 md:mt-0 max-w-2xl">
          <img
            // src="https://cdn.prod.website-files.com/6703f76c902df755b27afd5c/671a568f31e8a98567c19008_pexels-rdne-8292895.jpg"
            src="https://cdn.prod.website-files.com/6703f76c902df755b27afd5c/671a575f050f09d0cde7a510_pexels-vividcafe-681333.jpg"
            alt="Real Estate"
            className=" shadow-lg max-w-full "
          />
        </div>
